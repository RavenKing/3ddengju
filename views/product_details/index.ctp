<div class="productDetails index">
	<h2><?php __('Product Details');?></h2>
	<table cellpadding="0" cellspacing="0">
	<tr>
			<th><?php echo $this->Paginator->sort('id');?></th>
			<th><?php echo $this->Paginator->sort('pdetail_name');?></th>
	...
	?>
	<tr<?php echo $class;?>>
		<td><?php echo $productDetail['ProductDetail']['id']; ?>&nbsp;</td>
		<td><?php echo $productDetail['ProductDetail']['pdetail_name']; ?>&nbsp;</td>
		<td>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View', true), array('action' => 'view', $productDetail['ProductDetail']['id'])); ?>
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $productDetail['ProductDetail']['id'])); ?>
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $productDetail['ProductDetail']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $productDetail['ProductDetail']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
